...
def subgraphdeepneat_xor_example_1(_):
    """"""
    ...
    config_file_path = './subgraphdeepneat_xor_example_1_config.cfg'
    ...
    ne_algorithm = tfne.algorithms.SubGraphDeepNEAT(config=config,
...
if __name__ == '__main__':
    app.run(subgraphdeepneat_xor_example_1)
